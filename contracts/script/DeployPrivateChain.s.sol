...
/// @title DeployPrivateChain
/// @notice Deploys trust-layer contracts to the Polygon Edge private chain (chainId 100100).
///         Only CredentialRegistry and TrustAttestationVerifier are deployed here;
///         shared contracts (DIDRegistry, VCHashAnchors, AttestationVerifier) remain on Sepolia.
contract DeployPrivateChain is Script {
    uint256 internal constant EXPECTED_CHAIN_ID = 100100;
    ...
    function run() external {
        require(block.chainid == EXPECTED_CHAIN_ID, "Wrong chain: expected 100100");
        ...
        console2.log("NETWORK: private-chain (100100)");
